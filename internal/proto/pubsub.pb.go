...
// 	protoc        v6.30.2
// source: internal/proto/pubsub.proto
...
func (x *PublishRequest) Reset() {
	*x = PublishRequest{}
	mi := &file_internal_proto_pubsub_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_pubsub_proto_rawDescGZIP(), []int{1}
}
...
func (x *Event) Reset() {
	*x = Event{}
	mi := &file_internal_proto_pubsub_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return file_internal_proto_pubsub_proto_rawDescGZIP(), []int{2}
}
...
const file_internal_proto_pubsub_proto_rawDesc = "" +
	"\n" +
	"\x1binternal/proto/pubsub.proto\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\aPublish\x12\x0f.PublishRequest\x1a\x16.google.protobuf.EmptyB\x10Z\x0einternal/protob\x06proto3"

var (
	file_internal_proto_pubsub_proto_rawDescOnce sync.Once
	file_internal_proto_pubsub_proto_rawDescData []byte
)

func file_internal_proto_pubsub_proto_rawDescGZIP() []byte {
	file_internal_proto_pubsub_proto_rawDescOnce.Do(func() {
		file_internal_proto_pubsub_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_proto_pubsub_proto_rawDesc), len(file_internal_proto_pubsub_proto_rawDesc)))
	})
	return file_internal_proto_pubsub_proto_rawDescData
}

var file_internal_proto_pubsub_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_proto_pubsub_proto_goTypes = []any{
...
func file_internal_proto_pubsub_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_proto_pubsub_proto_rawDesc), len(file_internal_proto_pubsub_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
